...
define config.name = _("起始归原:破碎的希望-第一章")
...
这是由作者的经历改编的故事...:\n
    ...
    -希望淡然,病魔缠身-\n
    -我希望我能认真,但'他们'并不想让我认真-\n
    -我最想完成自己的事情,但'他们'不让我完成-\n
    -我的梦想终究实现,但'他们'不想让我的梦想不会实现-\n
    -我认为我做得好,但'他们'认为我做的差-\n
    -当我充满这希望的时候,'他们'想把我拉进绝望深渊-\n
    -我,Mango,一个降临到这个不友好的世界中-\n
    -我的命运会究竟如何?-\n

    -注意:你只能改变'主角'的命运,不能改变'现实'中的命运-\n
""")
...
define config.save_directory = "BrokenHope-1646490079"
...
init python:
    ...
    #build.classify('game/**.rpy', 'scripts')
    #build.classify('game/**.rpyc', 'scripts')
    build.classify('game/qrcode/**.png', 'qrcode')
